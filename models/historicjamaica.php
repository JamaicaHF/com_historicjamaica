...
/**
 * HistoricJamaica Model
 *
 * @since  0.0.1
 */
//**********************************************************************************************************************************************
class HistoricJamaicaModelHistoricJamaica extends JModelItem
{
    /**
     * @var string message
     */
     ...
     */
    public function getItem($pk = null) //getMsg()
    {
        DefineGlobalValues();
        ExecuteAction();
        return $this->message;
...
function DefineGlobalValues()
{
    ...
    {
        define("HJ_HOSTSERVER","https://".$_SERVER["SERVER_NAME"]);
